...
const EmpresaVarejo = {
    id:   "varejo",
    icon: Icone('shopping-cart',16,'var(--s-primary)'),
    nome: "Rede de Varejo",
    ...
    intros: [
        {
            ...
            secoes: [
                {
                    icone: Icone('building-2',16,'var(--s-primary)'),
                    titulo: "A Empresa",
                ...
                {
                    icone: Icone('trending-down',16,'var(--s-primary)'),
                ...
                {
                    icone: Icone('triangle-alert',16,'var(--s-primary)'),
                ...
                {
                    icone: Icone('target',16,'var(--s-primary)'),
            ...
            alerta: { icone: Icone('siren',16,'var(--danger)'), titulo: "Margem em Queda" },
        ...
        
        {
            ...
            alerta: { icone: Icone('siren',16,'var(--danger)'), titulo: "Concorrência Nacional Chegou" },
        ...
        
        {
            ...
            alerta: { icone: Icone('siren',16,'var(--danger)'), titulo: "Expansão Desequilibrada" },
