...
const EmpresaLogistica = {
    id:   "logistica",
    icon: Icone('truck',16,'var(--s-primary)'),
    ...
    intros: [
        {
            ...
            alerta: { icone: Icone('siren',16,'var(--danger)'), titulo: "SLA em Descumprimento" },
        ...
        
        {
            ...
            alerta: { icone: Icone('siren',16,'var(--danger)'), titulo: "Falha na Cadeia do Frio" },
        ...
        
        {
            ...
            alerta: { icone: Icone('siren',16,'var(--danger)'), titulo: "Capacidade no Limite" },
