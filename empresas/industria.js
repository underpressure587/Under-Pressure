...
const EmpresaIndustria = {
    id:   "industria",
    icon: Icone('factory',16,'var(--s-primary)'),
    ...
    intros: [
        {
            ...
            alerta: { icone: Icone('siren',16,'var(--danger)'), titulo: "Segurança e ISO em Risco" },
        ...
        
        {
            ...
            alerta: { icone: Icone('siren',16,'var(--danger)'), titulo: "Adequação ESG Urgente" },
        ...
        
        {
            ...
            alerta: { icone: Icone('siren',16,'var(--danger)'), titulo: "Autuação Ambiental Ativa" },
