...
const EmpresaTecnologia = {
    id:   "tecnologia",
    icon: Icone('rocket',16,'var(--s-primary)'),
    ...
    intros: [
        ...
        
        {
            ...
            alerta: { icone: Icone('siren',16,'var(--danger)'), titulo: "Crise em Andamento" },
        ...
        
        {
            ...
            alerta: { icone: Icone('siren',16,'var(--danger)'), titulo: "Runway Crítico" },
        ...
        
        {
            ...
            alerta: { icone: Icone('siren',16,'var(--danger)'), titulo: "Pipeline Travado" },
