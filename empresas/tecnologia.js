...
const EmpresaTecnologia = {
    ...
    intros: [
        ...
        
        {
            ...
            alerta: { icone: Icone('siren',16), titulo: "Crise em Andamento" },
        ...
        
        {
            ...
            alerta: { icone: Icone('siren',16), titulo: "Runway Crítico" },
        ...
        
        {
            ...
            alerta: { icone: Icone('siren',16), titulo: "Pipeline Travado" },
