            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  const Icon(Icons.person_outline_rounded, size: 16, color: AppTheme.t2),
                  ...
                  children: [
                    Container(
                      ...
                      child: _data?['fotoUrl'] != null &&
                          ...
                          ? ClipOval(
                              child: Image.network(_data!['fotoUrl'],
                                  fit: BoxFit.cover,
                                  errorBuilder: (_, __, ___) => Center(
                                      child: Text(_initial,
                                          style: AppTheme.syne(size: 28, weight: FontWeight.w700, color: Colors.black)))),
                            )
                          : Center(
                              child: Text(_initial,
                                  style: AppTheme.syne(size: 28, weight: FontWeight.w700, color: Colors.black))),
                    ...
                    Text('${_data?['totalJogos'] ?? 0} mandatos concluídos',
                        style: AppTheme.inter(size: 13, color: AppTheme.t3)),
                    const SizedBox(height: 24),
                    Row(
                      children: [
                        Expanded(child: _StatCard(label: 'Partidas', value: '${_data?['totalJogos'] ?? 0}')),
                        const SizedBox(width: 10),
                        Expanded(child: _StatCard(
                            label: 'Melhor Score',
                            value: (_data?['melhorScore'] ?? 0) > 0
                                ? '${_data!['melhorScore']}'
                                : '—')),
                      ],
                    ),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 12),
                          Text('Suas conquistas aparecerão aqui após jogar.',
                              style: AppTheme.inter(size: 13, color: AppTheme.t3)),
                        ],
                      ),
                    ),
...
class _StatCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          Text(value, style: AppTheme.syne(size: 24, weight: FontWeight.w800, color: AppTheme.primary)),
          const SizedBox(height: 4),
          Text(label, style: AppTheme.inter(size: 12, color: AppTheme.t3)),
        ],
      ),
    );
  }
